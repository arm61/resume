...
\begin{cventries}
  \cventryyy
    ...
    {BRISTOL, GB}
    {AUG. 2023 - ONGOING}
    {Leading the \href{https://scams-research.github.io}{statistical chemical analysis methods} research group at the University of Bristol and teaching on Scientific Computing topics}
  \cventryyy
    {Instrument Data Scientist for Neutron Reflectometry}
    {European Spallation Source ERIC}
    {K\O BENHAVN, DK \& LUND, SE}
    {JAN. 2021 - AUG. 2023}
    {Leading data reduction and analysis development for reflectometry instruments at the European Spallation Source Data Management and Software Centre}
  ...
  \cventryyy
    ...
    {HARWELL-OXFORD, GB}
    {APR. 2019 - DEC. 2020}
    {A collaborative project between Diamond Light Source, ISIS Neutron and Muon Source and the Ada Lovelace Centre to increase automation in neutron and X-ray reflectometry reduction and analysis}
