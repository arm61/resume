...
\begin{cventries}
  \cventry
    {Peer Reviewer}
    {American Chemical Society/Open Journals/International Union of Crystallograpy}
    {}
    {MAY 2020 - PRESENT}
    {
        \begin{cvitems}
            \item{Carried out peer review for Journal of Physical Chemistry, Journal of Open Source Software \& Journal of Applied Crystallography}
        \end{cvitems}
    }
  \cventry
    {Member}
