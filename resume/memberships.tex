...
\begin{cventries}
  \cventry
    ...
    {
        \begin{cvitems}
            \item{Carried out peer review for Journal of Physical Chemistry (American Chemical Society), Journal of Open Source Software (Open Journals) \& Journal of Applied Crystallography (International Union of Crystallography)}
        \end{cvitems}
    }
  \cventry
    {Member}
