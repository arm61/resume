...
\cvsubsection{Software development}
	\begin{cvskills}
    	\cvskill{$\;\;\;\;\;\;$falassGUI}{A pure python library for the calculation of neutron and X-ray reflectometry data from molecular simulaiton. This is an open source package available on \href{http://www.github.com/arm/falassGUI}{GitHub}. This library was developed as part of my PhD studies.}
