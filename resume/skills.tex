...
\cvsubsection{Software development}
	...
	\cvskill{kinisi}{An robust methodology for uncertainty quantification in \emph{in-silico} diffusion, implemented in an open-source Python package and available on Github.}
