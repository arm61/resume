...
\begin{dayenumerate}
  \cvpresentation
    {Methods Matter: A Case for Careful Analysis of Molecular Simulation}
	{CCP5 Summer School 2026}
	{NEWCASTLE, UK}
	{2026/07/27}
  \cvpresentation
    {Bayesian Model Selection Provides a Robust Tool for Experimental Analysis}
	  {Machine Learning for Experimental Materials Data}
	  {LONDON, UK}
	  {2026/04/02}
  \cvpresentation
    {A Case for Good Simulation To Complement Neutron Scattering: A p-QENS Example}
    {Neutron Scattering Group Early Career Meeting}
    {BRISTOL, UK}
    {2026/01/16} 
  \cvpresentation
    {Accurate Diffusion Estimation From Simulation and the Impacts on Temperature Dependent Modelling}
    {University of Bristol, School of Mathematics, Fluids and Materials Seminar}
    {BRISTOL, UK}
    {2026/01/15}
  \cvpresentation
  ...
  \cvpresentation
    ...
    {GAITHERSBURG, US}
    {2016/05/23}
\end{dayenumerate}\vspace{-0.5cm}
\cvsubsection{Contributed Talks}
\begin{dayenumerate}
  \cvpresentation
    {Lost in Translation: Simulation-Informed Bayesian Inference for Quasi-Elastic Neutron Scattering}
	{UK Neutron and Muon Science User Meeting 2026}
	{WARWICK, UK}
	{2026/04/14}
  \cvpresentation
    {Accurate Diffusion Estimation From Simulation and Propagation to Temperature Dependent Modelling}
